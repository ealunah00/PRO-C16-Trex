...
function setup() {
  ...
  trex.setCollider("circle",0,0,40);  //  CAMBIAR A RECTÁNGULO Y AGRANDARLO
  trex.debug = true
...
function draw() {
  ...
  if(gameState === PLAY) {
    ...
    ground.velocityX = -4;                    //  ACELERAR EL MOVIMIENTO DEL SUELO

    //puntuación
    score = score + Math.round(frameCount/60);
    
    //  CONDICIÓN PARA EL SONIDO CADA 100 PUNTOS
    ...
    //aparecer las nubes y los obstáculos
    spawnClouds();
    spawnObstacles();
    ...
    if(obstaclesGroup.isTouching(trex)){
        ...
        //  HACER SALTAR AL TREX Y AGREGAR SONIDO DE SALTO
...
function spawnObstacles() {
 if (frameCount % 60 === 0) {
    ...
    obstacle.velocityX = -6;                    //  ACELERAR EL MOVIMIENTO DE LOS OBSTÁCULOS
